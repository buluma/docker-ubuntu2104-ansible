# Ubuntu 21.04 LTS (Focal Fossa) Ansible Test Image
...
Ubuntu 21.04 LTS (Focal Fossa) Docker container for Ansible playbook and role testing.
...
## How to Use
  ...
  2. Pull this image from Docker Hub: `docker pull buluma/docker-ubuntu2104-ansible:latest` (or use the image you built earlier, e.g. `ubuntu2004-ansible:latest`).
